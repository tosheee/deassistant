...
class Admin::ProductsControllerTest < ActionController::TestCase
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post :create, admin_product: { product_category_id: @admin_product.product_category_id, product_name: @admin_product.product_name }
    end
  ...
  test "should update admin_product" do
    patch :update, id: @admin_product, admin_product: { product_category_id: @admin_product.product_category_id, product_name: @admin_product.product_name }
    assert_redirected_to admin_product_path(assigns(:admin_product))
  end
